...
export default function CartModal({
  ...
  useEffect(() => {
    ...
    if (data?.totalQuantity !== quantityRef.current) {
      ...
      quantityRef.current = data?.totalQuantity;
    }
  }, [isOpen, data?.totalQuantity, quantityRef]);
  return (
    <>
              ...
              {!cart || cart.lines.length === 0 ? (
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                  <ul className="flex-grow overflow-auto py-4">
                    {data &&
                      data.lines.map((item: CartItem, i: number) => {
